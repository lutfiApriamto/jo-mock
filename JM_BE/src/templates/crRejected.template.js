/**
 * Template email notifikasi CR ditolak — dikirim hanya ke submitter CR.
 * @param {{
...
export const crRejectedTemplate = ({
  ...
  const rejectedAt = new Date().toLocaleString('id-ID', {
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                <tr>
                  <td style="background-color:#FFF9F9;border-left:3px solid #F04438;border-radius:0 6px 6px 0;padding:14px 18px;">
                    <p style="margin:0 0 4px;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;color:#8B889C;letter-spacing:0.8px;text-transform:uppercase;">Alasan Penolakan</p>
  ...
  return {
    subject: `Change Request Ditolak — ${projectName}`,

    text: `Halo ${submitterName},\n\nChange Request yang Anda ajukan pada project "${projectName}" tidak disetujui oleh PM.\n\nRingkasan CR: ${description}${reasonText}\n\nDitolak oleh: ${pmName}\nWaktu: ${rejectedAt} WIB\n\nAnda dapat mengajukan CR baru dengan revisi yang lebih detail melalui dashboard:\n${dashboardUrl}\n\n— Tim JO-MOCK`,
...
<head>
  ...
  <title>Change Request Ditolak — ${projectName}</title>
</head>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="background-color:#FFFFFF;padding:20px 40px 40px;border-left:1px solid #E5E1EF;border-right:1px solid #E5E1EF;">
              ...
              <h1 style="margin:0 0 16px;font-family:'Trebuchet MS',Georgia,serif;font-size:22px;font-weight:700;color:#1A1726;line-height:1.3;">Change Request Anda tidak disetujui</h1>

              <p style="margin:0 0 8px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.7;color:#5B5870;">
                Halo, <strong style="color:#1A1726;">${submitterName}</strong>!
              </p>
              <p style="margin:0 0 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.7;color:#5B5870;">
                Setelah ditinjau oleh PM, Change Request yang Anda ajukan pada project <strong style="color:#1A1726;">${projectName}</strong> tidak dapat disetujui saat ini.
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                <tr>
                  <td style="background-color:#F4F3FB;border-left:3px solid #6C5CE7;border-radius:0 6px 6px 0;padding:14px 18px;">
                    <p style="margin:0 0 4px;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;color:#8B889C;letter-spacing:0.8px;text-transform:uppercase;">Deskripsi CR Anda</p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;border:1px solid #E5E1EF;border-radius:8px;overflow:hidden;">
                <tr>
                  <td style="padding:14px 20px;background-color:#FAFAFA;border-bottom:1px solid #E5E1EF;">
                    <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;color:#8B889C;letter-spacing:0.8px;text-transform:uppercase;">Detail Review</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:16px 20px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#8B889C;padding-bottom:10px;vertical-align:top;">Ditinjau oleh</td>
                      ...
                      <tr>
                        ...
                        <td style="padding-bottom:10px;">
                          <span style="display:inline-block;background-color:#FFF1F2;border:1px solid #FECDD3;color:#E11D48;font-family:Arial,sans-serif;font-size:11px;font-weight:700;padding:2px 10px;border-radius:100px;">Ditolak</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#8B889C;vertical-align:top;">Waktu</td>
                        <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#1A1726;font-weight:600;">${rejectedAt} WIB</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background-color:#FFFBEB;border-left:3px solid #F59E0B;border-radius:0 6px 6px 0;padding:14px 16px;">
                    <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#5B5870;line-height:1.6;">
                      <strong style="color:#1A1726;">Langkah berikutnya</strong><br>
                      Anda dapat mendiskusikan perubahan ini bersama PM, lalu mengajukan CR baru dengan deskripsi dan detail yang lebih lengkap melalui dashboard.
                    </p>
                  </td>
                </tr>
              </table>
