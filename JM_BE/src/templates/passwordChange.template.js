/**
 * Template email notifikasi ketika user mengubah password melalui pengaturan akun.
 * Berbeda dari resetPassword.template.js yang dipakai untuk alur lupa password.
...
export const passwordChangeTemplate = ({ name }) => {
  ...
  return {
    ...
    text: `Halo ${name},\n\nPassword akun JO-MOCK Anda telah berhasil diubah melalui pengaturan akun pada ${changedAt} WIB.\n\nSemua sesi aktif di perangkat lain telah dihapus. Silakan login ulang menggunakan password baru Anda.\n\nJika Anda tidak melakukan perubahan ini, segera gunakan fitur "Lupa Password" untuk mengamankan akun.\n\n— Tim JO-MOCK`,
          ...
          <tr>
            <td style="background-color:#FFFFFF;padding:20px 40px 40px;border-left:1px solid #E5E1EF;border-right:1px solid #E5E1EF;">
              ...
              <p style="margin:0 0 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.7;color:#5B5870;">
                Password akun JO-MOCK Anda telah berhasil diperbarui melalui pengaturan akun. Gunakan password baru Anda untuk login ke semua perangkat.
              </p>
                  ...
                  <td style="padding:16px 20px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#1A1726;font-weight:600;padding-bottom:10px;">Ganti Password</td>
                      </tr>
                      <tr>
                ...
                <tr>
                  <td style="background-color:#F4F3FB;border-left:3px solid #6C5CE7;border-radius:0 6px 6px 0;padding:14px 16px;">
                    <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#5B5870;line-height:1.6;">
                      <strong style="color:#1A1726;">Sesi lain telah dihapus.</strong><br>
                      Demi keamanan, semua sesi aktif di perangkat lain telah otomatis dihapus. Silakan login ulang menggunakan password baru Anda.
                    </p>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td style="background-color:#FFF9F9;border-left:3px solid #F04438;border-radius:0 6px 6px 0;padding:14px 16px;">
                    <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#5B5870;line-height:1.6;">
                      ...
                      Jika Anda tidak mengubah password, akun Anda mungkin dalam bahaya. Segera gunakan fitur <strong>Lupa Password</strong> untuk mengambil alih akun.
                    </p>
                  </td>
                </tr>
              </table>
