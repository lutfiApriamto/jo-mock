 ...
 * }} params
 */
export const crSubmittedTemplate = ({
  pmName,
  submitterName,
  submitterRole,
  projectName,
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td style="padding-bottom:10px;">
                          <span style="display:inline-block;background-color:#EDE9FE;color:#6C5CE7;font-family:Arial,sans-serif;font-size:11px;font-weight:700;padding:2px 10px;border-radius:100px;">${submitterRole}</span>
                          <span style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#8B889C;margin-left:6px;">${roleLabel}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#8B889C;padding-bottom:10px;vertical-align:top;">Project</td>
